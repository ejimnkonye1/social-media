  ...
  <div class={`container profile${darkMode ? ' bg-dark' : ' bg-light'}`} >
    <div class="row">
            ...
            <div class={`card mb-3 ${darkMode ? ' bg-dark' : ' bg-light'}`}>
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <a href="#d"><img src="https://bootdey.com/img/Content/avatar/avatar6.png" alt="" width="50" class="rounded-circle" /></a>
                        <div class="flex-fill ps-2">
                            <div class="fw-bold"><a href="#d" class="text-decoration-none">Jonthy</a> at <a href="#d" class="text-decoration-none">Enugu , Nigeria</a></div>
                            <div>
                    ...
                    <div class="profile-img-list">
                        <div class="profile-img-list-item main">
                            <a href="#d" data-lity="" class="profile-img-list-link">
                    ...
                    <div class="row text-center fw-bold">
                        <div class="col">
                            <a href="#d" class="text-body text-opacity-50 text-decoration-none d-block p-2 march " > <i class="far fa-thumbs-up me-1 d-block d-sm-inline "></i><span className="march">Likes</span>  </a>
                        </div>
                        <div class="col">
                            <a href="#d" class="text-body text-opacity-50 text-decoration-none d-block p-2"> <i class="far fa-comment me-1 d-block d-sm-inline"></i><span className="march"> Comment</span> </a>
                        </div>
                        <div class="col">
                            <a href="#d" class="text-body text-opacity-50 text-decoration-none d-block p-2"> <i class="fa fa-share me-1 d-block d-sm-inline"></i> <span className="march">Share</span> </a>
                        </div>
                    </div>
      ...
      <div class="box-comment">
        <img className="img-circle img-sm" src="https://bootdey.com/img/Content/avatar/avatar5.png" alt="User Image" />
      ...
      <div class="box-comment">
                        ...
                        <div class="flex-fill ps-2">
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <div class="position-absolute end-0 text-center">
                                    <a href="#d" class="text-body text-opacity-50 me-2"><i class="fa fa-smile"></i></a>
                                    <a href="#d" class="text-body text-opacity-50 me-2"><i class="fa fa-camera"></i></a>
                                    <a href="#d" class="text-body text-opacity-50 me-2"><i class="fa fa-video"></i></a>
                                    <a href="#d" class="text-body text-opacity-50 me-3"><i class="fa fa-paw"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12gi">
            <div class={`card  ${darkMode ? ' bg-dark' : ' bg-light'}`}>
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <a href="#d"><img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="" width="50" class="rounded-circle" /></a>
                        <div class="flex-fill ps-2">
                            <div class="fw-bold"><a href="#d" class="text-decoration-none">Clyde Stanley</a> at <a href="#d" class="text-decoration-none">United States</a></div>
                    ...
                    <div class="profile-img-list">
                        ...
                        <div class="profile-img-list-item">
                            <a href="#dd" data-lity="" class="profile-img-list-link">
                            <span className="profile-img-content" style={{ backgroundImage: 'url(https://bootdey.com/img/Content/avatar/avatar3.png)' }}></span>
                            </a>
                        </div>
                        <div class="profile-img-list-item">
                    ...
                    <div class="row text-center fw-bold">
                        <div class="col">
                            <a href="#d" class="text-body text-opacity-50 text-decoration-none d-block p-2"> <i class="far fa-thumbs-up me-1 d-block d-sm-inline"></i> <span className="march">Likes</span> </a>
                        </div>
                        <div class="col">
                            <a href="#d" class="text-body text-opacity-50 text-decoration-none d-block p-2"> <i class="far fa-comment me-1 d-block d-sm-inline"></i> <span className="march">Comment</span> </a>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill ps-2">
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <div class="position-absolute end-0 text-center">
                                    <a href="#d" class="text-body text-opacity-50 me-2"><i class="fa fa-smile"></i></a>
                                    <a href="#dd" class="text-body text-opacity-50 me-2"><i class="fa fa-camera"></i></a>
                                    <a href="#d" class="text-body text-opacity-50 me-2"><i class="fa fa-video"></i></a>
                                    <a href="#d" class="text-body text-opacity-50 me-3"><i class="fa fa-paw"></i></a>
                                </div>
                            </div>
